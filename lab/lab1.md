...
## Due 4/8/2022 (Friday) at 11:59pm.
...
below. You need to use either a x86_64 linux machine or a mac. You
can also use attu by logging into it remotely (`ssh attu.cs.washington.edu`).

```
$ git clone git@gitlab.cs.washington.edu:xk-public/22sp.git xk
Cloning into xk...
$ cd xk
```

You want to create your own repository on gitlab instead of
...
$ cd <proj_name>
$ git remote add upstream git@gitlab.cs.washington.edu:xk-public/22sp.git
```
...
a complete PC: thZZe code you write for the emulator will boot on a
...
Please write down both the line number and the code in this line.
...
Please also explain how you found to the answer for the last part of this question.
