...
struct dinode {
  ...
  int extra_extents_blk_nums[28];       // extra extent block numbers for files
//  int extra_extent_start_num; //marks the starting block number of first "extra" extent used
                              //helps flag how many blocks are contiguous
                              //basically blocks are assumed contiguous until dealing with extra blocks
};
